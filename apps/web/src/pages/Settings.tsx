      ...
      <Box maxWidth="720px" mx="auto" p={2}>
        <Paper sx={{ p: 3, borderRadius: 3 }}>
          ...
          <form onSubmit={handleSubmit}>
            <Stack spacing={2}>
              <TextField label="当前密码" type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} required />
              <TextField label="新密码" type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required helperText="至少 8 位" />
